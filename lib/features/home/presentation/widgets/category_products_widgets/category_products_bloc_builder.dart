...
import 'package:marketi/features/home/presentation/widgets/category_products_widgets/category_products_list_view.dart';
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<ProductsCubit, ProductsState>(
      builder: (context, state) {
        ...
        return CategoryProductsListView(products: state.products);
      },
    );
  }
}
