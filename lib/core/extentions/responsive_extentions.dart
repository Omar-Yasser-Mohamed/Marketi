...
extension ResponsiveExtension on num {
  SizedBox get horizontalSpace => SizedBox(width: ResponsiveConfig.width(toDouble()));
  SizedBox get verticalSpace => SizedBox(height: ResponsiveConfig.height(toDouble()));
