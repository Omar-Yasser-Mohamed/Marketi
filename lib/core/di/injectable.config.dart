...
import 'package:marketi/core/utils/connectivity_helper.dart' as _i762;
...
extension GetItInjectableX on _i174.GetIt {
  ...
  _i174.GetIt init({
    ...
    gh.lazySingleton<_i762.ConnectivityHelper>(
      () => _i762.ConnectivityHelper(),
    );
    gh.lazySingleton<_i352.ApiService>(
      () => _i352.ApiService(
        gh<_i951.DioService>(),
        gh<_i762.ConnectivityHelper>(),
      ),
    );
    return this;
  }
